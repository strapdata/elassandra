...
public final class CFMetaData
{
    ...
    // used by elassandra, added there for performance reasons (built when CFMetadata change).
    public class CqlFragments {
        ...
        public CqlFragments() {
            ...
            for (ColumnDefinition cd : partitionKeyColumns) {
    ...
    private volatile CqlFragments cqlFragments = null;
