 ...
 */
package org.elassandra.cluster.service;
...
import org.elasticsearch.cluster.service.ClusterService.ClusterServiceTaskBatcher.UpdateTask;
...
public class ClusterService extends org.elasticsearch.cluster.service.ClusterService {
    ...
    */
    ...
    public ClusterService(Settings settings, ClusterSettings clusterSettings, ThreadPool threadPool, Supplier<DiscoveryNode> localNodeSupplier) {
        ...
        //this.discoveryService = localNodeSupplier.get().;
        this.tokenRangeService = new TokenRangesService(settings);
        this.cassandraSecondaryIndicesApplier = new CassandraSecondaryIndicesApplier(settings, this, indicesService);
    ...
    public void setIndicesService(IndicesService metaStateService) {
        this.indicesService = metaStateService;
    }
    
    public void setDiscovery(CassandraDiscovery discovery) {
    ...
    public void updateTableSchema(final IndexService indexService, final MappingMetaData mappingMd) throws IOException {
        try {
            String ksName = indexService.mapperService().keyspace();
            ...
            updateMapping(indexService.index().getName(), mappingMd);
    ...
    protected void doStart() {
        ...
        // start/stop shards before updating CQL3
        this.addHighPriorityApplier(new CassandraIndicesClusterStateService(this.settings, this.indicesService, this, this.threadPool));
    ...
    */
    ...
    public Map<UUID, ShardRoutingState> getShardRoutingStates(org.elasticsearch.index.Index index) {
        ...
        try {
            IndexShard localIndexShard = indexServiceSafe(index).getShard(0);
