 ...
 *
 */
public class TransportShardSnapshotAction extends TransportReplicationAction<ShardSnapshotRequest, ShardSnapshotRequest, ActionWriteResponse> {

    public static final String NAME = SnapshotAction.NAME + "[s]";

    @Inject
    public TransportShardSnapshotAction(Settings settings, TransportService transportService, ClusterService clusterService,
        ...
        super(settings, NAME, transportService, clusterService, indicesService, threadPool, mappingUpdatedAction,
                actionFilters, indexNameExpressionResolver, ShardSnapshotRequest.class, ShardSnapshotRequest.class, ThreadPool.Names.FLUSH);
    }
    ...
    @Override
    protected Tuple<ActionWriteResponse, ShardSnapshotRequest> shardOperationOnPrimary(MetaData metaData, ShardSnapshotRequest shardRequest) throws Throwable {
        ...
        // Cassandra snapshot for all mapped tables.
    ...
    @Override
    protected void shardOperationOnReplica(ShardSnapshotRequest request) {
    }
