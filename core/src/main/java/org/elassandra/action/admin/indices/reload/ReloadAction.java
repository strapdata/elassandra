...
public class ReloadAction extends Action<ReloadRequest, ReloadResponse, ReloadRequestBuilder> {
    ...
    public static final String NAME = "indices:admin/reload";
    ...
    @Override
    public ReloadRequestBuilder newRequestBuilder(ElasticsearchClient client) {
        return new ReloadRequestBuilder(client, this);
    }
}
