 ...
 * @see org.elasticsearch.client.IndicesAdminClient#cleanup(SnapshotRequest)
 * @see SnapshotResponse
 */
public class SnapshotRequest extends BroadcastRequest<SnapshotRequest> {
     ...
     */
    public SnapshotRequest(ActionRequest originalRequest) {
        super(originalRequest);
    }

    public SnapshotRequest(String... indices) {
        super(indices);
    }
