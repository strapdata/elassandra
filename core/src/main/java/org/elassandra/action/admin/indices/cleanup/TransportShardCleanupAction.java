 ...
 *
 */
public class TransportShardCleanupAction extends TransportReplicationAction<ShardCleanupRequest, ShardCleanupRequest, ActionWriteResponse> {
    ...
    public TransportShardCleanupAction(Settings settings, TransportService transportService, ClusterService clusterService,
        ...
        super(settings, NAME, transportService, clusterService, indicesService, threadPool, mappingUpdatedAction,
                actionFilters, indexNameExpressionResolver, ShardCleanupRequest.class, ShardCleanupRequest.class, ThreadPool.Names.FLUSH);
    }
    ...
    @Override
    protected Tuple<ActionWriteResponse, ShardCleanupRequest> shardOperationOnPrimary(MetaData metaData, ShardCleanupRequest shardRequest) throws Throwable {
    ...
    @Override
    protected void shardOperationOnReplica(ShardCleanupRequest request) {
    }
