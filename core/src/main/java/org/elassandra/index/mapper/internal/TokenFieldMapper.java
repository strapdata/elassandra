...
public class TokenFieldMapper extends MetadataFieldMapper {
    ...
    public static class Defaults {
        ...
        static {
            ...
            TOKEN_FIELD_TYPE.setNumericPrecisionStep(InternalCassandraClusterService.defaultPrecisionStep);
            TOKEN_FIELD_TYPE.setIndexAnalyzer(NumericLongAnalyzer.buildNamedAnalyzer(InternalCassandraClusterService.defaultPrecisionStep));
