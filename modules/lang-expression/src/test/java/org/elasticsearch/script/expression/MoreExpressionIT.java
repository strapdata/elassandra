...
public class MoreExpressionIT extends ESIntegTestCase {
    ...
    public void testBasic() throws Exception {
        ...
        assertEquals((Object)5.0, rsp.getHits().getAt(0).field("foo").getValue());
    }
    ...
    public void testDateMethods() throws Exception {
        ...
        SearchHits hits = rsp.getHits();
        assertEquals((Object)5.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)(-11.0), hits.getAt(1).field("foo").getValue());
        rsp = buildRequest("doc['date0'].getHourOfDay() + doc['date1'].getDayOfMonth()").get();
        assertEquals(2, rsp.getHits().getTotalHits());
        hits = rsp.getHits();
        assertEquals((Object)5.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)24.0, hits.getAt(1).field("foo").getValue());
        rsp = buildRequest("doc['date1'].getMonth() + 1").get();
        assertEquals(2, rsp.getHits().getTotalHits());
        hits = rsp.getHits();
        assertEquals((Object)9.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)10.0, hits.getAt(1).field("foo").getValue());
        rsp = buildRequest("doc['date1'].getYear()").get();
        assertEquals(2, rsp.getHits().getTotalHits());
        hits = rsp.getHits();
        assertEquals((Object)1985.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)1983.0, hits.getAt(1).field("foo").getValue());
    }
    ...
    public void testMultiValueMethods() throws Exception {
        ...
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)5.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)2.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)5.0, hits.getAt(2).field("foo").getValue());

        rsp = buildRequest("doc['double0'].sum()").get();
        assertSearchResponse(rsp);
        hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)7.5, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)5.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)6.0, hits.getAt(2).field("foo").getValue());

        rsp = buildRequest("doc['double0'].avg() + doc['double1'].avg()").get();
        assertSearchResponse(rsp);
        hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)4.3, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)8.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)5.5, hits.getAt(2).field("foo").getValue());

        rsp = buildRequest("doc['double0'].median()").get();
        assertSearchResponse(rsp);
        hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)1.5, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)5.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)1.25, hits.getAt(2).field("foo").getValue());

        rsp = buildRequest("doc['double0'].min()").get();
        assertSearchResponse(rsp);
        hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)1.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)5.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)(-1.5), hits.getAt(2).field("foo").getValue());
        ...
        hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)2.5, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)5.0, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)1.5, hits.getAt(2).field("foo").getValue());
    }
    ...
    public void testSparseField() throws Exception {
        ...
        assertEquals(2, rsp.getHits().getTotalHits());
        assertEquals((Object)5.0, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)1.0, hits.getAt(1).field("foo").getValue());
    }
    ...
    public void testParams() throws Exception {
        ...
        SearchHits hits = rsp.getHits();
        assertEquals(3, hits.getTotalHits());
        assertEquals((Object)24.5, hits.getAt(0).field("foo").getValue());
        assertEquals((Object)9.5, hits.getAt(1).field("foo").getValue());
        assertEquals((Object)13.5, hits.getAt(2).field("foo").getValue());
    }
