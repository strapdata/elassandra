...
public class PluginBuildPlugin extends BuildPlugin {
    ...
    private static void configureDependencies(Project project) {
        project.dependencies {
            compileOnly "com.strapdata.elasticsearch:elasticsearch:${project.versions.elasticsearch}"
            testCompile "com.strapdata.elasticsearch.test:framework:${project.versions.elasticsearch}"
