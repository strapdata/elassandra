...
public class ShortFieldMapper extends NumberFieldMapper<Short> {
    ...
    public static class Builder extends NumberFieldMapper.Builder<Builder, ShortFieldMapper> {
        ...
        public ShortFieldMapper build(BuilderContext context) {
            ...
            ShortFieldMapper fieldMapper = new ShortFieldMapper(buildNames(context), fieldType.numericPrecisionStep(), boost, fieldType, singleValue, docValues, nullValue,
    ...
    protected ShortFieldMapper(Names names, int precisionStep, float boost, FieldType fieldType, Boolean monoValued, Boolean docValues,
                               Short nullValue, Explicit<Boolean> ignoreMalformed, Explicit<Boolean> coerce,
                               PostingsFormatProvider postingsProvider, DocValuesFormatProvider docValuesProvider,
                               SimilarityProvider similarity, Loading normsLoading, @Nullable Settings fieldDataSettings, 
                               Settings indexSettings, MultiFields multiFields, CopyTo copyTo) {
        super(names, precisionStep, boost, fieldType, monoValued, docValues, ignoreMalformed, coerce, new NamedAnalyzer("_short/" + precisionStep,
