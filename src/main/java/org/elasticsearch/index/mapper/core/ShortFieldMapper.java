...
public class ShortFieldMapper extends NumberFieldMapper<Short> {
    ...
    public static class Builder extends NumberFieldMapper.Builder<Builder, ShortFieldMapper> {
        ...
        public ShortFieldMapper build(BuilderContext context) {
            ...
            ShortFieldMapper fieldMapper = new ShortFieldMapper(buildNames(context), fieldType.numericPrecisionStep(), boost, fieldType, 
    ...
    protected ShortFieldMapper(Names names, int precisionStep, float boost, FieldType fieldType, 
        ...
        super(names, precisionStep, boost, fieldType, cqlCollection, cqlStruct, cqlPartialUpdate, docValues, ignoreMalformed, coerce, new NamedAnalyzer("_short/" + precisionStep,
