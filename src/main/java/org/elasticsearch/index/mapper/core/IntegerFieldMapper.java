...
public class IntegerFieldMapper extends NumberFieldMapper<Integer> {
    ...
    public static class Builder extends NumberFieldMapper.Builder<Builder, IntegerFieldMapper> {
        ...
        public IntegerFieldMapper build(BuilderContext context) {
            ...
            IntegerFieldMapper fieldMapper = new IntegerFieldMapper(buildNames(context), fieldType.numericPrecisionStep(), boost, fieldType, singleValue, docValues,
    ...
    protected IntegerFieldMapper(Names names, int precisionStep, float boost, FieldType fieldType, Boolean monoValued, Boolean docValues,
