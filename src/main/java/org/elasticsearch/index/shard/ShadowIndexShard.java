...
public final class ShadowIndexShard extends IndexShard {
    ...
    public ShadowIndexShard(ShardId shardId, @IndexSettings Settings indexSettings, IndexSettingsService indexSettingsService,
                            ...
                            MergePolicyProvider mergePolicyProvider, EngineFactory factory, ClusterService clusterService, ElasticSchemaService elasticSchemaManager) {
        super(shardId, indexSettings, indexSettingsService, indicesLifecycle, store, mergeScheduler,
                ...
                similarityService, mergePolicyProvider, factory, clusterService, elasticSchemaManager);
    }
