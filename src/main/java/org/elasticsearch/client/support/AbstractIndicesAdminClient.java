...
import org.elasticsearch.action.admin.indices.rebuild.RebuildAction;
import org.elasticsearch.action.admin.indices.rebuild.RebuildRequest;
import org.elasticsearch.action.admin.indices.rebuild.RebuildRequestBuilder;
import org.elasticsearch.action.admin.indices.rebuild.RebuildResponse;
...
public abstract class AbstractIndicesAdminClient implements IndicesAdminClient {
    ...
    @Override
    public ActionFuture<RebuildResponse> rebuild(final RebuildRequest request) {
        return execute(RebuildAction.INSTANCE, request);
    }
    ...
    public RebuildRequestBuilder prepareRebuild(String... indices) {
        return new RebuildRequestBuilder(this).setIndices(indices);
    }
