...
import org.elasticsearch.action.delete.XDeleteAction;
...
import org.elasticsearch.action.get.XGetAction;
import org.elasticsearch.action.get.XGetRequest;
import org.elasticsearch.action.get.XGetRequestBuilder;
import org.elasticsearch.action.get.XGetResponse;
import org.elasticsearch.action.get.XMultiGetAction;
import org.elasticsearch.action.get.XMultiGetRequest;
import org.elasticsearch.action.get.XMultiGetRequestBuilder;
import org.elasticsearch.action.get.XMultiGetResponse;
import org.elasticsearch.action.index.IndexAction;
import org.elasticsearch.action.index.IndexRequest;
import org.elasticsearch.action.index.IndexRequestBuilder;
import org.elasticsearch.action.index.IndexResponse;
import org.elasticsearch.action.index.XIndexAction;
...
public abstract class AbstractClient implements Client {
    ...
    @Override
    public ActionFuture<XIndexResponse> xindex(final XIndexRequest request) {
        return execute(XIndexAction.INSTANCE, request);
    }

    @Override
    public void xindex(final XIndexRequest request, final ActionListener<XIndexResponse> listener) {
        execute(XIndexAction.INSTANCE, request, listener);
    }
    ...
    @Override
    public ActionFuture<XDeleteResponse> xdelete(final XDeleteRequest request) {
        return execute(XDeleteAction.INSTANCE, request);
    }

    @Override
    public void xdelete(final XDeleteRequest request, final ActionListener<XDeleteResponse> listener) {
        execute(XDeleteAction.INSTANCE, request, listener);
    }
    ...
    @Override
    public ActionFuture<XGetResponse> xget(final XGetRequest request) {
        return execute(XGetAction.INSTANCE, request);
    }

    @Override
    public void xget(final XGetRequest request, final ActionListener<XGetResponse> listener) {
        execute(XGetAction.INSTANCE, request, listener);
    }
    
    
    @Override
    public XGetRequestBuilder prepareXGet() {
        return new XGetRequestBuilder(this, null);
    }

    @Override
    public XGetRequestBuilder prepareXGet(String index, String type, String id) {
        return prepareXGet().setIndex(index).setType(type).setId(id);
    }
    ...
    @Override
    public ActionFuture<XMultiGetResponse> xmultiGet(final XMultiGetRequest request) {
        return execute(XMultiGetAction.INSTANCE, request);
    }

    @Override
    public void xmultiGet(final XMultiGetRequest request, final ActionListener<XMultiGetResponse> listener) {
        execute(XMultiGetAction.INSTANCE, request, listener);
    }

    @Override
    public XMultiGetRequestBuilder prepareXMultiGet() {
        return new XMultiGetRequestBuilder(this);
    }
