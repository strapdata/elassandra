...
public class Requests {
    ...
    /**
     * Create an index request against a specific index. Note the {@link UpsertRequest#type(String)} must be
     * set as well and optionally the {@link UpsertRequest#id(String)}.
     *
    ...
    /**
     * Creates a delete request against a specific index. Note the {@link UpdelRequest#type(String)} and
     * {@link UpdelRequest#id(String)} must be set.
     *
