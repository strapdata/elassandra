...
public interface Client extends ElasticsearchClient<Client>, Releasable {
     ...
     */
    ActionFuture<XIndexResponse> xindex(XIndexRequest request);
     ...
     * @see Requests#indexRequest(String)
     */
    void xindex(XIndexRequest request, ActionListener<XIndexResponse> listener);

    /**
     * Insert a document in cassandra table, and a SecondaryIndex will perform xindex of its content.
     * <p/>
     * <p>The id is optional, if it is not provided, one will be generated automatically.
     *
     * @param request The index request
     ...
     */
    ActionFuture<XDeleteResponse> xdelete(XDeleteRequest request);
     ...
     * @see Requests#deleteRequest(String)
     */
    void xdelete(XDeleteRequest request, ActionListener<XDeleteResponse> listener);

    /**
     * Deletes a document from cassandra, and ElasticSecondaryIndex performs a xdelete to update elastic index.
     *
     * @param request The delete request
     * @return The result future
     * @see Requests#deleteRequest(String)
     ...
     * @see Requests#getRequest(String)
     */
    ActionFuture<XGetResponse> xget(XGetRequest request);
     ...
     * @see Requests#getRequest(String)
     */
    void xget(XGetRequest request, ActionListener<XGetResponse> listener);

    /**
     * Gets the document that was indexed from an index with a type and id.
     */
    XGetRequestBuilder prepareXGet();

    /**
     * Gets the document that was indexed from an index with a type (optional) and id.
     */
    XGetRequestBuilder prepareXGet(String index, @Nullable String type, String id);
     ...
     * Multi get documents.
     */
    ActionFuture<XMultiGetResponse> xmultiGet(XMultiGetRequest request);

    /**
     * Multi get documents.
     */
    void xmultiGet(XMultiGetRequest request, ActionListener<XMultiGetResponse> listener);

    /**
     * Multi get documents.
     */
    XMultiGetRequestBuilder prepareXMultiGet();
