...
public class IndicesStatsResponse extends BroadcastOperationResponse implements ToXContent {
    ...
    IndicesStatsResponse(ShardStats[] shards, CassandraClusterState clusterState, int totalShards, int successfulShards, int failedShards, List<ShardOperationFailedException> shardFailures) {
