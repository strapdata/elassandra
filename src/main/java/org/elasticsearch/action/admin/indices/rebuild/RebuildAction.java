...
/**
 */
public class RebuildAction extends IndicesAction<RebuildRequest, RebuildResponse, RebuildRequestBuilder> {
    ...
    @Override
    public RebuildRequestBuilder newRequestBuilder(IndicesAdminClient client) {
        return new RebuildRequestBuilder(client);
    }
}
