...
public class TransportIndexAction extends TransportShardReplicationOperationAction<IndexRequest, IndexRequest, IndexResponse> {
    ...
    public TransportIndexAction(Settings settings, TransportService transportService, ClusterService clusterService,
    							MetaDataCreateIndexService createIndexService, IndicesService indicesService, ThreadPool threadPool, ShardStateAction shardStateAction,
    ...
    protected void doExecute(final IndexRequest request, final ActionListener<IndexResponse> listener) {
        ...
        if (autoCreateIndex.shouldAutoCreate(request.index(), clusterService.state())) {
            ...
            */
        	...
        	CreateIndexClusterStateUpdateRequest  createIndexRequest = new CreateIndexClusterStateUpdateRequest(request, "auto(index api)", request.index())
    ...
    @Override
    protected boolean resolveRequest(CassandraClusterState state, InternalRequest request, ActionListener<IndexResponse> indexResponseActionListener) {
    ...
    @Override
    protected PrimaryResponse<IndexResponse, IndexRequest> shardOperationOnPrimary(CassandraClusterState clusterState, PrimaryOperationRequest shardRequest) throws Throwable {
