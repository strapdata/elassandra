 ...
 * </ul>
 */
public class TransportXIndexAction extends TransportShardReplicationOperationAction<XIndexRequest, XIndexRequest, XIndexResponse> {
    ...
    public TransportXIndexAction(Settings settings, TransportService transportService, ClusterService clusterService,
                                ...
                                ElasticSchemaService elasticSchemaManager, ActionFilters actionFilters) {
    ...
    @Override
    protected void doExecute(final XIndexRequest request, final ActionListener<XIndexResponse> listener) {
    ...
    private void innerExecute(final XIndexRequest request, final ActionListener<XIndexResponse> listener) {
    ...
    @Override
    protected XIndexRequest newRequestInstance() {
        return new XIndexRequest();
    }

    @Override
    protected XIndexRequest newReplicaRequestInstance() {
        return new XIndexRequest();
    }

    @Override
    protected XIndexResponse newResponseInstance() {
        return new XIndexResponse();
    }
    ...
    protected PrimaryResponse<XIndexResponse, XIndexRequest> shardOperationOnPrimary(ClusterState clusterState, PrimaryOperationRequest shardRequest) throws Throwable {
        ...
        try {
            ...
            if (request.opType() == XIndexRequest.OpType.INDEX) {
            ...
            XIndexResponse response = new XIndexResponse(shardRequest.shardId.getIndex(), request.type(), request.id(), version, created);
            return new PrimaryResponse<XIndexResponse, XIndexRequest>(shardRequest.request, response, op);
    ...
    protected void shardOperationOnReplica(ReplicaOperationRequest shardRequest) {
        ...
        XIndexRequest request = shardRequest.request;
