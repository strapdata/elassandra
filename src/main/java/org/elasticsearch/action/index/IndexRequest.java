...
public class IndexRequest extends ShardReplicationOperationRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
        ...
        public static OpType fromString(String sOpType) throws ElasticsearchIllegalArgumentException {
            ...
            switch(lowersOpType){
                ...
                case "insert_if_not_exists":
                    return OpType.INSERT_IF_NOT_EXISTS;
                default:
    ...
    private OpType opType = OpType.INSERT;
    ...
    public IndexRequest create(boolean create) {
        if (create) {
            return opType(OpType.INSERT);
        } else {
            return opType(OpType.INSERT_IF_NOT_EXISTS);
        }
    }
    ...
    /**
     * Set to <tt>true</tt> to force this index to use {@link OpType#INSERT}.
     */
    public IndexRequest insert(boolean create) {
        if (create) {
            return opType(OpType.INSERT);
        } else {
            return opType(OpType.INSERT_IF_NOT_EXISTS);
