 ...
 * @see org.elasticsearch.client.Client#index(UpsertRequest)
 */
public class XIndexRequest extends ShardReplicationOperationRequest<XIndexRequest> implements DocumentRequest<XIndexRequest> {
     ...
     */
    public XIndexRequest(ActionRequest request) {
        super(request);
    }
     ...
     */
    public XIndexRequest(XIndexRequest indexRequest, ActionRequest originalRequest) {
     ...
     */
    public XIndexRequest(String index) {
        this.index = index;
    }
     ...
     * {@link #source(byte[])} must be set.
     */
    public XIndexRequest(String index, String type) {
        this.index = index;
        this.type = type;
    }
     ...
     */
    public XIndexRequest(String index, String type, String id) {
        this.index = index;
        this.type = type;
        this.id = id;
    }
     ...
     */
    public XIndexRequest contentType(XContentType contentType) {
     ...
     */
    public XIndexRequest type(String type) {
        this.type = type;
        return this;
    }
     ...
     */
    public XIndexRequest id(String id) {
        this.id = id;
        return this;
    }
     ...
     * and not the id.
     */
    public XIndexRequest routing(String routing) {
     ...
     * routing as well.
     */
    public XIndexRequest parent(String parent) {
        this.parent = parent;
        if (routing == null) {
            routing = parent;
        }
     ...
     */
    public XIndexRequest timestamp(String timestamp) {
     ...
     */
    public XIndexRequest ttl(Long ttl) throws ElasticsearchGenerationException {
        if (ttl == null) {
            this.ttl = -1;
            return this;
        }
     ...
     */
    public XIndexRequest source(Map source) throws ElasticsearchGenerationException {
     ...
     * @param source The map to index
     */
    public XIndexRequest source(Map source, XContentType contentType) throws ElasticsearchGenerationException {
        try {
     ...
     */
    public XIndexRequest source(String source) {
     ...
     */
    public XIndexRequest source(XContentBuilder sourceBuilder) {
        source = sourceBuilder.bytes();
        sourceUnsafe = false;
        return this;
    }

    public XIndexRequest source(String field1, Object value1) {
        try {
            XContentBuilder builder = XContentFactory.contentBuilder(contentType);
    ...
    public XIndexRequest source(String field1, Object value1, String field2, Object value2) {
        try {
            XContentBuilder builder = XContentFactory.contentBuilder(contentType);
    ...
    public XIndexRequest source(String field1, Object value1, String field2, Object value2, String field3, Object value3) {
        try {
            XContentBuilder builder = XContentFactory.contentBuilder(contentType);
    ...
    public XIndexRequest source(String field1, Object value1, String field2, Object value2, String field3, Object value3, String field4, Object value4) {
        try {
            XContentBuilder builder = XContentFactory.contentBuilder(contentType);
    ...
    public XIndexRequest source(Object... source) {
     ...
     */
    public XIndexRequest source(BytesReference source, boolean unsafe) {
        this.source = source;
     ...
     * Sets the document to index in bytes form.
     */
    public XIndexRequest source(byte[] source) {
     ...
     */
    public XIndexRequest source(byte[] source, int offset, int length) {
     ...
     */
    public XIndexRequest source(byte[] source, int offset, int length, boolean unsafe) {
     ...
     */
    public XIndexRequest opType(OpType opType) {
        this.opType = opType;
        return this;
    }

    /**
     * Sets a string representation of the {@link #opType(org.elasticsearch.action.index.XIndexRequest.OpType)}. Can
     * be either "index" or "create".
     */
    public XIndexRequest opType(String opType) throws ElasticsearchIllegalArgumentException {
     ...
     */
    public XIndexRequest create(boolean create) {
        if (create) {
     ...
     * to <tt>false</tt>.
     */
    public XIndexRequest refresh(boolean refresh) {
     ...
     */
    public XIndexRequest version(long version) {
     ...
     */
    public XIndexRequest versionType(VersionType versionType) {
    ...
    public void process(MetaData metaData, @Nullable MappingMetaData mappingMd, boolean allowIdGeneration, String concreteIndex) throws ElasticsearchException {
        ...
        if (allowIdGeneration) {
            if (id == null) {
                ...
                opType(XIndexRequest.OpType.CREATE);
