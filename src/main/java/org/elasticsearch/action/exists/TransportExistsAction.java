...
public class TransportExistsAction extends TransportBroadcastOperationAction<ExistsRequest, ExistsResponse, ShardExistsRequest, ShardExistsResponse> {
    ...
    @Override
    protected GroupShardsIterator shards(CassandraClusterState clusterState, ExistsRequest request, String[] concreteIndices) {
    ...
    @Override
    protected ClusterBlockException checkGlobalBlock(CassandraClusterState state, ExistsRequest request) {
        return state.blocks().globalBlockedException(ClusterBlockLevel.READ);
    }

    @Override
    protected ClusterBlockException checkRequestBlock(CassandraClusterState state, ExistsRequest countRequest, String[] concreteIndices) {
        return state.blocks().indicesBlockedException(ClusterBlockLevel.READ, concreteIndices);
    }

    @Override
    protected ExistsResponse newResponse(ExistsRequest request, AtomicReferenceArray shardsResponses, CassandraClusterState clusterState) {
