...
/**
 * A bulk request holds an ordered {@link UpsertRequest}s and {@link UpdelRequest}s and allows to executes
...
public class BulkRequest extends ActionRequest<BulkRequest> implements CompositeIndicesRequest {
    ...
    /**
     * Adds an {@link UpsertRequest} to the list of actions to execute. Follows the same behavior of {@link UpsertRequest}
    ...
    /**
     * Adds an {@link UpdelRequest} to the list of actions to execute.
     */
