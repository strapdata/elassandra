 ...
 */
public class TransportXGetAction extends TransportShardSingleOperationAction<XGetRequest, XGetResponse> {

    private final IndicesService indicesService;
    private final boolean realtime;

    @Inject
    public TransportXGetAction(Settings settings, ClusterService clusterService, TransportService transportService,
    ...
    @Override
    protected XGetResponse shardOperation(XGetRequest request, ShardId shardId) throws ElasticsearchException {
        ...
        return new XGetResponse(result);
    }

    @Override
    protected XGetRequest newRequest() {
        return new XGetRequest();
    }

    @Override
    protected XGetResponse newResponse() {
        return new XGetResponse();
    }
}
