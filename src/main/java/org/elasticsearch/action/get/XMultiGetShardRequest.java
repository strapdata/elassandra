...
public class XMultiGetShardRequest extends SingleShardOperationRequest<XMultiGetShardRequest> {
    ...
    List<XMultiGetRequest.Item> items;

    XMultiGetShardRequest() {

    }

    XMultiGetShardRequest(XMultiGetRequest multiGetRequest, String index, int shardId) {
     ...
     */
    public XMultiGetShardRequest preference(String preference) {
    ...
    public XMultiGetShardRequest realtime(Boolean realtime) {
        this.realtime = realtime;
        return this;
    }

    public XMultiGetShardRequest ignoreErrorsOnGeneratedFields(Boolean ignoreErrorsOnGeneratedFields) {
    ...
    public XMultiGetShardRequest refresh(boolean refresh) {
        this.refresh = refresh;
        return this;
    }

    void add(int location, XMultiGetRequest.Item item) {
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_1_4_0_Beta1)) {
            for (int i = 0; i < size; i++) {
                ...
                items.add(XMultiGetRequest.Item.readItem(in));
            }
        } else {
            ...
            for (int i = 0; i < size; i++) {
                ...
                XMultiGetRequest.Item item = new XMultiGetRequest.Item(index, types.get(i), ids.get(i))
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(Version.V_1_4_0_Beta1)) {
            ...
            for (int i = 0; i < locations.size(); i++) {
                out.writeVInt(locations.get(i));
                XMultiGetRequest.Item item = items.get(i);
                if (item.type() == null) {
