 ...
 * @see org.elasticsearch.client.Client#get(XGetRequest)
 */
public class XGetRequest extends SingleShardOperationRequest<XGetRequest> {
     ...
     */
    public XGetRequest(XGetRequest getRequest, ActionRequest originalRequest) {
     ...
     * must be set.
     */
    public XGetRequest(String index) {
        super(index);
        this.type = "_all";
    }
     ...
     */
    public XGetRequest(ActionRequest request, String index) {
        super(request, index);
    }
     ...
     */
    public XGetRequest(String index, String type, String id) {
        super(index);
        this.type = type;
        this.id = id;
    }
     ...
     */
    public XGetRequest type(@Nullable String type) {
        if (type == null) {
            type = "_all";
        }
        this.type = type;
     ...
     */
    public XGetRequest id(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    public XGetRequest parent(String parent) {
        if (routing == null) {
            routing = parent;
        }
        return this;
     ...
     * and not the id.
     */
    public XGetRequest routing(String routing) {
     ...
     */
    public XGetRequest preference(String preference) {
     ...
     */
    public XGetRequest fetchSourceContext(FetchSourceContext context) {
     ...
     */
    public XGetRequest fields(String... fields) {
        this.fields = fields;
        return this;
    }
     ...
     * to <tt>false</tt>.
     */
    public XGetRequest refresh(boolean refresh) {
    ...
    public XGetRequest realtime(Boolean realtime) {
    ...
    public XGetRequest version(long version) {
     ...
     */
    public XGetRequest versionType(VersionType versionType) {
        this.versionType = versionType;
        return this;
    }

    public XGetRequest ignoreErrorsOnGeneratedFields(boolean ignoreErrorsOnGeneratedFields) {
