 ...
 */
public class XGetResponse extends ActionResponse implements Iterable<GetField>, ToXContent {
    ...
    public XGetResponse(GetResult getResult) {
    ...
    public static XGetResponse readGetResponse(StreamInput in) throws IOException {
        XGetResponse result = new XGetResponse();
        result.readFrom(in);
        return result;
    }
