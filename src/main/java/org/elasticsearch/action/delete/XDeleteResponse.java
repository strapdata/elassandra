 ...
 */
public class XDeleteResponse extends ActionResponse {
    ...
    public XDeleteResponse() {

    }

    public XDeleteResponse(String index, String type, String id, long version, boolean found) {
        this.index = index;
        this.id = id;
        this.type = type;
