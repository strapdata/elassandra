...
public class InternalRange<B extends InternalRange.Bucket, R extends InternalRange<B, R>> extends InternalMultiBucketAggregation<R, B>
    ...
    public final static Type TYPE = new Type("token_range");
    ...
    public static class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Range.Bucket {
        ...
        protected String generateKey(long from, long to, ValueFormatter formatter) {
            StringBuilder sb = new StringBuilder();
            sb.append('(').append(formatter.format(from)).append(',').append(formatter.format(to)).append(']');
            return sb.toString();
        }
    ...
    protected void doReadFrom(StreamInput in) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ranges.add(getFactory().createBucket(key, in.readLong(), in.readLong(), in.readVLong(), InternalAggregations.readAggregations(in), keyed, formatter));
        }
        this.ranges = ranges;
        this.rangeMap = null;
    }
