...
package org.elasticsearch.discovery.cassandra.publish;
...
public class PublishClusterStateAction extends AbstractComponent {
    ...
    public static final String ACTION_NAME = "internal:discovery/cassandra/publish";
    ...
    private void publish(final CassandraClusterState clusterState, final Set<DiscoveryNode> nodesToPublishTo,
        ...
        for (final DiscoveryNode node : nodesToPublishTo) {
            ...
            try {
                ...
                logger.debug("cluster_state sent to {}", node);
            } catch (Throwable t) {
        ...
        if ((nodesToPublishTo.size() > 0) && (publishTimeout.millis() > 0)) {
