...
public class DiscoverySettings extends AbstractComponent {
    ...
    public static final String PUBLISH_TIMEOUT = "discovery.cassandra.publish_timeout";
    public static final String NO_MASTER_BLOCK = "discovery.cassandra.no_master_block";
    ...
    public final static ClusterBlock NO_MASTER_BLOCK_ALL = new ClusterBlock(NO_MASTER_BLOCK_ID, "no cassandra ring", true, true, RestStatus.SERVICE_UNAVAILABLE, ClusterBlockLevel.ALL);
    public final static ClusterBlock NO_MASTER_BLOCK_WRITES = new ClusterBlock(NO_MASTER_BLOCK_ID, "no cassandra ring", true, false, RestStatus.SERVICE_UNAVAILABLE, EnumSet.of(ClusterBlockLevel.WRITE, ClusterBlockLevel.METADATA));
