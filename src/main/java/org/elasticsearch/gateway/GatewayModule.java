...
public class GatewayModule extends AbstractModule implements SpawnModules {
    ...
    public Iterable<? extends Module> spawnModules() {
        return ImmutableList.of(Modules.createModule(settings.getAsClass("gateway.type", CassandraGatewayModule.class, "org.elasticsearch.gateway.", "GatewayModule"), settings));
    }
