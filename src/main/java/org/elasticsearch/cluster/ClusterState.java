...
public class ClusterState implements ToXContent {
    ...
    public ClusterState(ClusterName clusterName, long version, MetaData metaData, RoutingTable routingTable, DiscoveryNodes nodes, ClusterBlocks blocks,
            ImmutableOpenMap<String, Custom> customs) {
     ...
     * <b>NOTE, the routing nodes are mutable, use them just for read
     * operations</b>
     */
    ...
    public enum Metric {
        VERSION("version"), MASTER_NODE("master_node"), BLOCKS("blocks"), NODES("nodes"), METADATA("metadata"), ROUTING_TABLE("routing_table"), CUSTOMS("customs");
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (metrics.contains(Metric.ROUTING_TABLE)) {
            // An empty array is written to maintain REST backwards
            // compatibility for 1.0 -> 1.x
