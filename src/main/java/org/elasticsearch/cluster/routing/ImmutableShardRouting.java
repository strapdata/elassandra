...
public class ImmutableShardRouting implements Streamable, Serializable, ShardRouting {
    ...
    public ImmutableShardRouting(ShardRouting copy) {
        this(copy.index(), copy.id(), copy.currentNodeId(), copy.primary(), copy.state(), copy.version(), copy.tokenRanges());
    ...
    public String shortSummary() {
        ...
        //sb.append(", tokens[").append(this.tokenRanges.toString()).append("]");
        return sb.toString();
    }
