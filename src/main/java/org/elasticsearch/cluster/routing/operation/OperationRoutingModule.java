...
import org.elasticsearch.cluster.routing.operation.cassandra.CassandraOperationRoutingModule;
...
public class OperationRoutingModule extends AbstractModule implements SpawnModules {
    ...
    public Iterable<? extends Module> spawnModules() {
        return ImmutableList.of(createModule(settings.getAsClass("cluster.routing.operation.type", CassandraOperationRoutingModule.class, "org.elasticsearch.cluster.routing.operation.", "OperationRoutingModule"), settings));
    }
