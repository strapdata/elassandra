...
public class IndexShardRoutingTable implements Iterable<ShardRouting> {
     ...
     */
    final ImmutableList<ShardRouting> allInitializingShards; // should be synchronized with all other nodes, but because we assume that remote indices are STARTED => always empty. 
