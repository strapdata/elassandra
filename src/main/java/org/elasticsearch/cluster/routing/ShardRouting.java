...
public final class ShardRouting implements Streamable, ToXContent {
    ...
    public ShardRouting(String index, int shardId, String currentNodeId,
        ...
        this(index, shardId,currentNodeId, relocatingNodeId, restoreSource, primary, state, version, unassignedInfo, AllocationId.newInitializing(), internal, expectedShardSize, ImmutableList.<Range<Token>> of());
    }
    ...
    public ShardRouting tokenRanges(Collection<Range<Token>> tokenRanges) {
        this.tokenRanges = tokenRanges;
        return this;
    }
    ...
    void initialize(String nodeId, long expectedShardSize) {
        ...
        //this.expectedShardSize = expectedShardSize;
        this.expectedShardSize = 1;     // all elassandra node start exactly one shard per index for ShardId(0).
    }
