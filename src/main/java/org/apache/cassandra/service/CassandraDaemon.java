...
public class CassandraDaemon
{
    ...
    protected static final Logger logger = LoggerFactory.getLogger(CassandraDaemon.class);
    ...
    /**
     * This is a hook for concrete daemons to initialize themselves suitably.
     * Subclasses should override this to initialize before cassandra bootstrap (called once from ServiceStorage.joinRing()).
     */
