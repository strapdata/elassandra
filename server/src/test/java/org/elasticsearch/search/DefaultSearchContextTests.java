...
public class DefaultSearchContextTests extends ESSingleNodeTestCase {
    ...
    public void testPreProcess() throws Exception {
        ...
        try (Directory dir = newDirectory();
            ...
            QueryPhaseExecutionException exception = expectThrows(QueryPhaseExecutionException.class, () -> context1.preProcess(false));
            ...
            exception = expectThrows(QueryPhaseExecutionException.class, () -> context1.preProcess(false));
            ...
            exception = expectThrows(QueryPhaseExecutionException.class, () -> context2.preProcess(false));
