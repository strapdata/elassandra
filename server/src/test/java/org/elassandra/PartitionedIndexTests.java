...
public class PartitionedIndexTests extends ESSingleNodeTestCase {
    ...
    public void multipleMappingTest() throws Exception {
        ...
        client().prepareIndex("fb", "messages","[\"Lisa\",201]")
    ...
    public void basicVirtualIndexTest() throws Exception {
        ...
        for(long i=20; i < 30; i++) {
            ...
            //System.out.println("ks_"+i+" properties="+properties);
...

        {
            ...
            if (!properties.containsKey("content2")) {
                ...
                System.out.println("extensions.ks=Ox"+ByteBufferUtil.bytesToHex(extensions.get("elastic_admin/ks")));
